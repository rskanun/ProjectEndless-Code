...
public class StatusEffectResource : ScriptableObject
{
    ...
    private static StatusEffectResource _instance;
    public static StatusEffectResource Instance
    {
        get
        {
            if (_instance != null) return _instance;

            _instance = Resources.Load<StatusEffectResource>("Option/StatusEffectResource");
            ...
            if (_instance == null)
            {
                ...
                if (_instance == null)
                {
                    _instance = CreateInstance<StatusEffectResource>();
